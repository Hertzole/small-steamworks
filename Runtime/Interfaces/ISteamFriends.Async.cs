...
namespace Hertzole.SmallSteamworks
{
	public partial interface ISteamFriends
	{
		...
		Task<UserInformationRetrievedResponse> RequestUserInformationAsync(in SteamID id,
		...
		/// <param name="cancellationToken">Optional cancellation token to cancel the task.</param>
		Task<AvatarRetrievedResponse> GetCurrentUserAvatarAsync(in AvatarSize size, CancellationToken cancellationToken = default);
		...
		/// <param name="size">The size of the avatar.</param>
		/// <param name="cancellationToken">Optional cancellation token to cancel the task.</param>
		Task<AvatarRetrievedResponse> GetAvatarAsync(in SteamID id, in AvatarSize size, CancellationToken cancellationToken = default);
	}
}